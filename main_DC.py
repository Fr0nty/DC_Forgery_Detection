...
def generate_signals(features, mean_normal, std_normal, epsilon=1e-10):
    ...
    danger_signal = 1.95 - safe_signal  # Higher distance means more anomalous
...
def train_and_evaluate(x_train, x_test, y_train, y_test, x_test_images):
    ...
    print(class_report)
    evaluate_and_plot(x_test, y_test, predictions, x_test_images)
...
def evaluate_and_plot(x_test, y_test, predictions, x_test_images):
